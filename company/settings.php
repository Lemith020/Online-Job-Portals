...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['update_password'])) {
    ...
    $user_result = $conn ? mysqli_query($conn, "SELECT password FROM users WHERE user_id = $user_id") : false;
...
<main class="main-content">
    ...
    <div class="card" style="margin-bottom:20px;">
        <h2 style="margin-bottom:16px; font-size:18px;">Security</h2>
        ...
        <form method="post" action="settings.php">
            ...
            <div class="modal-actions" style="max-width:240px; margin-top:20px;">
    ...
    <div class="card">
        <h2 style="margin-bottom:6px; font-size:18px;">Preferences</h2>
        <p style="font-weight:600; font-size:14px; margin-bottom:6px;">Notification Preferences</p>
        <p style="color:var(--muted); font-size:12px; margin-bottom:16px;">
            (Display only — email notifications use system default routing)
        </p>
