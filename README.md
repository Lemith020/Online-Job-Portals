...
```markdown
![Company Profile Screenshot](path/to/your/company_profile_image.png)
...
```markdown
![Job Management Screenshot](path/to/your/job_management_image.png)
...
```markdown
![ATS Dashboard Screenshot](path/to/your/ats_dashboard_image.png)
...
```markdown
![Interview Scheduling Screenshot](path/to/your/interview_scheduling_image.png)
...
```markdown
![Employer Dashboard Screenshot](path/to/your/employer_dashboard_image.png)
